...
export const poslSchema = yup.object({
  ...
  // Ficha
  typeOfRecord: yup.mixed<"POSl" | "POSll" | "WORK" | "COUPLE_WORK">().oneOf(["POSl", "POSll", "WORK", "COUPLE_WORK"]),
  courseNumber: yup.number(),
  parishAcronym: yup.string().max(6, "Máximo de 6 caracteres!").required("Campo Obrigatório!"),
  recordNumber: yup.number().required("Campo Obrigatório!"),
  ...
  candidatePhone: yup.string().min(14, "Mínimo de 14 caracteres!").max(15, "Máximo de 15 caracteres!").required("Campo Obrigatório!"),
  ...
  // Consentimento
  dataConsent: yup.boolean().oneOf([true], "Você deve aceitar o termo!").required("Campo Obrigatório!"),

  // Padrinho
  godfatherName: yup.string().required("Campo Obrigatório!"),
  godfatherPhone: yup.string().min(14, "Mínimo de 14 caracteres!").max(15, "Máximo de 15 caracteres!").required("Campo Obrigatório!"),
