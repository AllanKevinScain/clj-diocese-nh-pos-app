...
export interface PoslllFormInterface {
  onSubmit: (_: CandidatePoslllSchemaInfertype) => void;
  isDisabled?: boolean;
  isSending?: boolean;
  session?: Session;
}

export const PoslllForm = (props: PoslllFormInterface) => {
  const { onSubmit, isDisabled = false, isSending = false, session } = props;

  const { control, handleSubmit, setValue } = useFormContext<CandidatePoslllSchemaInfertype>();
    ...
    <Container>
      ...
      <form
        ...
        <div className="space-y-1 text-center">
          ...
          <Heading as="h2">FICHA DE CANDIDATO(A) AO CLJ III</Heading>
        </div>
